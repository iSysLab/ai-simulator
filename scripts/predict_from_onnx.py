...
사용법:
    # ANN/CNN (자동 판별)
    python scripts/predict_from_onnx.py results/onnx_samples/ann_h256_l2.onnx --device cpu

    # Transformer
    python scripts/predict_from_onnx.py results/onnx_samples/vit_d128_l4_h4.onnx \\
        --device cpu --embed-dim 128 --num-heads 4 --patch-size 4

    # GAN
    python scripts/predict_from_onnx.py results/onnx_samples/gan_z128_G256_512_1024.onnx \\
